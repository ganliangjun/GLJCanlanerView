...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GLJCanlanderView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/970721775@qq.com/GLJCanlanderView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '970721775@qq.com' => '970721775@qq.com' }
  s.source           = { :git => 'https://github.com/970721775@qq.com/GLJCanlanderView.git', :tag => s.version.to_s }
